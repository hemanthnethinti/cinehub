...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _tryLogin() async {
    ...
    try {
      final uri = Uri.parse('http://10.70.14.31:5000/login');
...
class _SignupScreenState extends State<SignupScreen> {
  ...
  Future<void> _sendOtp() async {
    ...
    try {
      final uri = Uri.parse('http://10.70.14.31:5000/send-otp');
  ...
  Future<void> _verifyOtp() async {
    ...
    try {
      final uri = Uri.parse('http://10.70.14.31:5000/verify-otp');
  ...
  Future<void> _register() async {
    ...
    final uri = Uri.parse('http://10.70.14.31:5000/register');
      ...
      if (resp.statusCode == 200) {
        ...
        if (parsed is Map && parsed['ok'] == true) {
          ...
          try {
            ...
            final luri = Uri.parse('http://10.70.14.31:5000/login');
